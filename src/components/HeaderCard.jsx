      ...
      <div className="main">
        ...
        <div id="c3" className="card">
          <div className="card-info">
            ...
            <li className="address">Praceta de Bissau nª1 ,3 E</li>
          </div>
        </div>
        <div id="c1" className="card">
          <div className="card-info">
            ...
            <div className="card-title">Iasaldo</div>
            <div className="card-subtitle">Batisita</div>
            <div className="card-social">
              <li id="cs2" className="card-social-icon">
                <svg viewBox="0 0 448 512" href="/public/avatar.jpg">
...
const StyledWrapper = styled.div.attrs({ "data-component": "HeaderCard" })`
  .main {
    display: grid;
    place-items: center;
    width: 190px;
...
// Nome legível para o devtools (ajuda também a mapear classes geradas)
StyledWrapper.displayName = "HeaderCardWrapper";
